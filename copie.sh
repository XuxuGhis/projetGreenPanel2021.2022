...
#curl -X GET -H "X-Authorization: Bearer $tok" "https://vrmapi.victronenergy.com/v2/installations/290/widgets/Graph?attributeCodes[]=IV1&attributeCodes[]=IV2&attributeCodes[]=IV3" > newresult


curl -X GET -H "X-Authorization: Bearer $tok"  "https://vrmapi.victronenergy.com/v2/installations/$id_site/system-overview" > systemoverview


curl -X GET -H "X-Authorization: Bearer $tok"  "https://vrmapi.victronenergy.com/v2/installations/288/stats?type=custom" > instancedata

#&start=1641859204&end=1641860344&interval=days" > instancedata
